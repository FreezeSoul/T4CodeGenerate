...
namespace CodeGen.UI
{
    ...
    public class ShellViewModel : ViewModelBase
    {
        ...
        public ShellViewModel()
        {
            ...
            SelectOutFolderLocationCommand = new RelayCommand(SelectOutFolderLocation);
            SelectOpenFolderLocationCommand = new RelayCommand(SelectOpenFolderLocation);
            ...
            SelectedDatabaseTypeItem = DbServerType.MySql.ToString();
        ...
        public RelayCommand SelectOutFolderLocationCommand { get; private set; }
        public RelayCommand SelectOpenFolderLocationCommand { get; private set; }
        ...
        private void DatabaseTypeSelectionChanged()
        {
            ...
            {
                FolderLocation = Path.Combine(currentWorkingDir, SelectedDatabaseTypeItem);
            }
        ...
        private void FileSelectionChanged()
        {
            ...
            {
                string fileFullPath = Path.Combine(FolderLocation, SelectedFile);
        ...
        private void SelectOutFolderLocation()
        {
            ...
            if (result == DialogResult.OK)
            {
                ...
                {
                    FolderLocation = newFolder;
                }
            }
        }

        private void SelectOpenFolderLocation()
        {
